%%
% This code can be downloaded from https://github.com/d-maurya/DIPCA_EIV_rot
...
%         3) hat_A :    This is a matrix of size (L - eta_guess) x (2*(L))
%                       which is multiplied with appropriate rotation matrix to get the
%                       coefficients of difference equation. This can be neglected if you
%                       are interested in out_par and inp_par only. 
%         4) out_par : this is a vector of dimension 1x(L+1). 
...
%         5) inp_par : this is a vector of dimension 1x(L+1). 
